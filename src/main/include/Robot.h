...
public:
  ...
  double robotSpeed = 0.2;      // maximum speed of field travel in the x or y direction - do not set > 1
  double robotTurnSpeed = 0.2;  // maximum turning speed - do not set > 1
  ...
  frc::Joystick controller{2};       // does the necessary adjustments for the flight simulator controller and creates a field
  ...
  PositionAndAngleTargeting autonomousTargeting{0.02, 0.016, 0.3, 0.3};
